let express,argon,UUID,identitySchema;_0b8‍.x([["default",()=>_0b8‍.o]]);_0b8‍.w("express",[["default",["express"],function(v){express=v}]]);_0b8‍.w("argon2",[["default",["argon"],function(v){argon=v}]]);_0b8‍.w("pure-uuid",[["default",["UUID"],function(v){UUID=v}]]);_0b8‍.w("../models/user",[["default",["identitySchema"],function(v){identitySchema=v}]]);
...
async function handleCreateCredentialsUsernamePassword(request, response) {
  _0b8‍.g.console.log("detais",request.body)
  if (typeof request.body.email !== "string" || request.body.email.length < 1) {
      return response.sendStatus(4001); 
  }
